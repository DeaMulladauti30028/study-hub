...
{
    // We’ll authorize in the controller against the group policy,
    // so allow the request object itself.
    return true;
}
...
public function rules(): array
{
    return [
        ...
        'file'    => ['nullable', 'file', 'required_without:content', 'max:10240', // 10 MB
